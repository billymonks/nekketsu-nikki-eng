...
Consistent translations for game-specific terms.

## Stats & Parameters

| Japanese | English | Notes |
|----------|---------|-------|
| 体力 (たいりょく) | HP | Health/Stamina |
| 攻撃力 (こうげきりょく) | ATK | Attack power |
| 防御力 (ぼうぎょりょく) | DEF | Defense |
| 根性 (こんじょう) | GUTS | Fighting spirit/willpower |
| 潜在能力 (せんざいのうりょく) | Potential | Hidden ability |
...
| 国語 (こくご) | Japanese | Japanese language class |
| 数学 (すうがく) | Math | |
| 理科 (りか) | Science | |
...
| Japanese | English | Notes |
|----------|---------|-------|
| 戦闘 (せんとう) | Battle | Combat/fight |
| パートナー | Partner | Team member |
| 仲間 (なかま) | Ally/Friend | |
| ライバル | Rival | |
| 届け物 (とどけもの) | delivery | Delivery quest |
| 決勝戦 (けっしょうせん) | finals | Final match |

## Board Game Terms

| Japanese | English | Notes |
|----------|---------|-------|
| マス | Space/Square | Board game space |
| 単位マス | Credit Space | Space that gives credits |
| ボーナスマス | Bonus Space | Special bonus space |
| チェックポイントマス | Checkpoint | Credit checkpoint |
| サイコロ | Dice | |
| ターン | Turn | |
| イベント | Event | |
| ルーレット | Roulette | Movement spinner |
| のろのろ | Slow | Roulette mode - small moves |
| イチバチ | All or Nothing | Roulette mode - 1 or 8 |
| 全開ダッシュ | Full Speed | Roulette mode - big moves |
| 強奪 (ごうだつ) | Steal | Take from opponent |
| 単位 (たんい) | Credits | Course credits to collect |
| 単位ポイント | Credit Points | Points from credits |
| ビンゴ表 | Bingo Board | Grid of credits to complete |
| カード | Card | Usable item cards |
| 完全燃焼技 | Burning Vigor | Special technique bonus |
| ジャスキャラ | Justice character | Game characters |

## Map Areas

| Japanese | English | Notes |
|----------|---------|-------|
| グラウンド北エリア | North Grounds | |
| グラウンド南エリア | South Grounds | |
| プールエリア | Pool Area | |
| 体育館エリア | Gym Area | |
| 屋上エリア | Rooftop | |
| 部室棟エリア | Club Building | |
| 1Fエリア | 1F | First floor |
| 2Fエリア | 2F | Second floor |
| 3Fエリア | 3F | Third floor |
